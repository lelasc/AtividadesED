...
public class LinkedQueue<Item> implements Iterable<Item> {
	...
	// método para verificar se um nome já está na fila (adicionado por nós)
	public boolean existe(String info) {
        Node aux = this.first;
        while (aux != null) {
            if (((String) aux.item).equalsIgnoreCase(info)) {
                return true;
            }
            aux = aux.next;
        }
...
/*
 * public static void main(String[] args) { LinkedQueue<String> queue = new
 * LinkedQueue<String>(); while (!StdIn.isEmpty()) { String item =
 * StdIn.readString(); if (!item.equals("-")) queue.enqueue(item); else if
 * (!queue.isEmpty()) StdOut.print(queue.dequeue() + " "); } StdOut.println("("
